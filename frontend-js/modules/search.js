...
export default class Search {
  ...
  closeOverlay() {
    document.querySelector('.search-overlay').classList.remove('search-overlay--visible');
  }
      ...
      <div class="search-overlay">
        <div class="search-overlay-top shadow-sm">
          <div class="container container--narrow">
            ...
            <input type="text" id="live-search-field" class="live-search-field" autocomplete="off" placeholder="What are you interested in?">
